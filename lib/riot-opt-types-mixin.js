...
/***/ function(module, exports, __webpack_require__) {
	...
	function createElementTypeChecker() {
	  function validate(opts, optName, componentName, location, optFullName) {
	    if (!ReactElement.isValidElement(opts[optName])) {
	      var locationName = 'opt';
	      return new Error('Invalid ' + locationName + ' `' + optFullName + '` supplied to ' + ('`' + componentName + '`, expected a single ReactElement.'));
	    }
	    return null;
	  }
	  return createChainableTypeChecker(validate);
	...
	function isNode(optValue) {
	  switch (typeof optValue) {
	    ...
	    case 'object':
	      ...
	      if (optValue === null || ReactElement.isValidElement(optValue)) {
	        return true;
	      }
